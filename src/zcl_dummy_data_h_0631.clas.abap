CLASS zcl_dummy_data_h_0631 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_dummy_data_h_0631 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

modify zempl_h_t100631 from table @( value #( ( employee = '1' manager = '' name = 'Name 1' )
                                              ...
                                              ( employee = '10' manager = '6' name = 'Name 10' ) ) ).
